...
import type { Prettify } from "@/utils/types/types.utils";
import type { Event } from "@microsoft/microsoft-graph-types";
import type { ComponentProps, MouseEvent } from "react";

export type WithChildren = Prettify<
  Readonly<ComponentProps<typeof Button> & { event?: never }>
>;

export type WithEvent = Prettify<
  Readonly<
    {
      children?: never;
      event: Event;
 ...
 */
export type CalendarEventProps = Readonly<WithChildren | WithEvent>;
