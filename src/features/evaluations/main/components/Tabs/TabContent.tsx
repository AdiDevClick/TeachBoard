...
import { TAB_CONTENT_VIEW_CARD_PROPS } from "@/features/evaluations/main/components/Tabs/config/tab-content.configs";
import {
  animateUnmountedElements,
  getAnimatedElements,
} from "@/features/evaluations/main/components/Tabs/functions/tabs.functions";
...
import type {
  LeftSideProps,
  TabContentProps,
} from "@/features/evaluations/main/components/Tabs/types/tabs.types";
