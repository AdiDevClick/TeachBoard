...
import type { SubSkillWithStudentsProps } from "@/features/evaluations/main/components/Accordion/types/subskill-with-students.types";
  ...
  return (
    ...
    >
      ...
      <EvaluationSliderList
        ...
        optional={(student) => {
          return {
            value: valueGetter(student.id, subSkill.id, module.id),
            criteria: subSkill.criteria,
          };
        }}
        inert
      />
