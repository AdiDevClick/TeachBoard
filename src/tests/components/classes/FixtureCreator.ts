  ...
  exposeGettersAsValues(params?: unknown): void {
    ...
    if (params && typeof params === "object") {
      for (const key of Object.keys(params)) {
        ...
        // Avoid redefining existing own properties
        if (Object.hasOwn(this, key)) continue;

        // Use the unified accessor helper so params keys expose an own
        // enumerable accessor that returns the supplied value.
  ...
  implements TaskTemplateDto
{
  ...
  constructor(params?: {
    ...
    // };
    // this.#degreeConfiguration = params?.degreeConfiguration;
    // this.#skills = params?.skills;

    this.exposeGettersAsValues(params);
    // this.exposeGettersAsValues({
    //   name: this.#name,
    //   task: this.#task,
  ...
  implements CreateDegreeResponseData
{
  ...
  constructor(params?: { degree?: DegreeRefDto }) {
    ...
    // });
    this.exposeGettersAsValues({
      degree: params?.degree ?? new DegreeFixtureCreator("FIELD"),
    });
    // this.exposeGettersAsValues({
    //   degree: this.#degree,
    // });
  ...
  implements TaskTemplatesFetch
{
  ...
  constructor(params?: {
    ...
    // ];
    // this.#shortTemplatesList = params?.shortTemplatesList;

    this.exposeGettersAsValues(params);
    // this.exposeGettersAsValues({
    //   taskTemplates: this.#taskTemplates,
    //   shortTemplatesList: this.#shortTemplatesList,
    // });
  }
}
